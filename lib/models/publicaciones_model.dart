...
PublicacionesModel welcomeFromJson(String str) =>
    PublicacionesModel.fromJson(json.decode(str));

String welcomeToJson(PublicacionesModel data) => json.encode(data.toJson());
...
class PublicacionesModel {
  ...
  List<PublicacionesData> data;

  factory PublicacionesModel.fromJson(Map<String, dynamic> json) =>
      PublicacionesModel(
        data: List<PublicacionesData>.from(
            json["data"].map((x) => PublicacionesData.fromJson(x))),
      );
